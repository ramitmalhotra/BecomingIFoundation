...
<head>
    ...
    <meta name="description" content="This allows you to search for Volunteers by projects">
    <meta name="author" content="Ramit Malhotra">

    <title>Voluneteers By Projects</title>
...
<body>
    ...
    <div class="container">
        ...
        <header class="jumbotron hero-spacer">
            <h1>Find volunteer contact information</h1>
        </header>
		<div>
    ...
    <script type="text/javascript">
		$(document).ready(function(){
			...
			$("#btn-click").on("click", function(){
				...
				var toSend = {"project":projectId,"functionName":"getVolunteers"};
				var jsonToSend = JSON.stringify(toSend);				
				$.ajax({
                    type: 'POST',
                    url: 'queryScript.php',
                    ...
                    success: function (data) {
                            ...
                            if(data.length === 0){
	                            ...
	                            $.each(data, function(key,value){
									$("#tableBody").append('<tr><td>'+value.fname+' '+value.sname+'</td><td>'+value.phone+'</td><td>'+value.email+'</td><td>'+value.role+'</td></tr>');
	                                });
