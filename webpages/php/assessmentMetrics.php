	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#btn-click").on("click", function(){
				...
				var toSend = {"project":projectId,"functionName":"getMetrics"};
				var jsonToSend = JSON.stringify(toSend);				
				$.ajax({
                    type: 'POST',
                    url: 'queryScript.php',
                    ...
                    success: function (data) {
                            ...
                            if(data.length === 0){
                                ...
                                alert("Sorry, no assessment metrics for this project right now!");
                            }
                            else{
	                            $.each(data, function(key,value){
									$("#tableBody").append('<tr><td>'+value.metric+'</td><td>'+value.assessgrade+'</td><td>'+value.assessnotes+'</td>');
	                                });
